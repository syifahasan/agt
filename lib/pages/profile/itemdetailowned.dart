...
class ItemDetailPageOwned extends StatefulWidget {
  const ItemDetailPageOwned({
    super.key,
  ...
  @override
  State<ItemDetailPageOwned> createState() => _ItemDetailPageOwnedState();
}

class _ItemDetailPageOwnedState extends State<ItemDetailPageOwned> {
